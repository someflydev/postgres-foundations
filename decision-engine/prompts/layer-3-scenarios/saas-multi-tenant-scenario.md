---
id: layer-3-scenarios/saas-multi-tenant-scenario
title: "Generate SaaS multi-tenant scenario"
consumed_by:
...
variables:
  industry_slug: saas_multi_tenant
  industry_title: SaaS multi-tenant
---
