# Pg HBA Concepts Level D2

## Scenario

Introduce a pg_hba overlay rule requiring SCRAM for app_scram_user and verify the matching rule in pg_hba_file_rules before testing login behavior.
