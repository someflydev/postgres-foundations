# First SELECT: Defend Query

Seed pack: `scheduling`, phase `1`.

Write the query independently against `scheduling.providers`. Do not look at `solution.sql` until after you have made an attempt. The expected result is both scheduling providers whose specialty is physical therapy or nutrition, ordered by display_name.
