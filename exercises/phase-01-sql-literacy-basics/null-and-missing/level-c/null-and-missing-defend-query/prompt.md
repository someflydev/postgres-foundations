# NULL and Missing Facts: Defend Query

Seed pack: `ecommerce`, phase `1`.

Write the query independently against `ecommerce.customers`. Do not look at `solution.sql` until after you have made an attempt. The expected result is the same columns and rows as the success criteria describe for this exercise.
