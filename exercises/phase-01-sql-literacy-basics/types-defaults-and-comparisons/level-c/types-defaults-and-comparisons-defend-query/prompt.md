# Types, Defaults, and Comparisons: Defend Query

Seed pack: `scheduling`, phase `1`.

Write the query independently against `scheduling.appointments`. Do not look at `solution.sql` until after you have made an attempt. The expected result is the same columns and rows as the success criteria describe for this exercise.
