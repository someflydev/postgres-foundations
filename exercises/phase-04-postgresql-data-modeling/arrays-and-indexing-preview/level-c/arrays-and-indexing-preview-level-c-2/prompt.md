# Prove the representation: Arrays and Indexing Preview
...
Use the lesson topic: recognizing that tags @> has an index shape without building it yet.

## Task

Write SQL that proves the good-fit representation works for a realistic question.
