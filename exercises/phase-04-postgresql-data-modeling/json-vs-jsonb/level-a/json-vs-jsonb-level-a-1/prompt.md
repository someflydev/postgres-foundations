# Recognize the good-fit use case: JSON vs JSONB
...
Use the Phase 4a seed data for `ecommerce`. The lesson topic is JSONB.

## Task

Explain or produce the requested JSONB result. Include a good-fit example and a bad-fit example in your reasoning.
