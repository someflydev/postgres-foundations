# Read the modeled rows: What Arrays Are Good For
...
Use the lesson topic: ARRAY['postgres','training'] tags on ecommerce.products.

## Task

Write a focused SQL statement for ARRAY['postgres','training'] tags on ecommerce.products.
