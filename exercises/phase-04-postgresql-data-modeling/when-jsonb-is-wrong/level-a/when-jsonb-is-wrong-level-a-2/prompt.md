# Spot the bad-fit use case: When JSONB Is Wrong
...
Explain or produce the requested JSONB misuse result. Include a good-fit example and a bad-fit example in your reasoning.
