# Normalization: 1NF, 2NF, 3NF Incident Review
...
Repeated customer and product facts need to move to their own keyed tables. The incident must be concrete: without this constraint, a bad row could violate a business rule that later workflows trust.
