...
Local row invariants must reject impossible quantities, totals, and time ranges.
## Task

Write the complete schema repair independently, including the constraints that enforce the named invariant. Target table(s): ecommerce.check_constraints_c_3.
