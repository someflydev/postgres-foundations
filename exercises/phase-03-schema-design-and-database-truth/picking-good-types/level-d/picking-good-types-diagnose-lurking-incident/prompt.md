# Picking Good Types Incident Review
...
Money, timestamps, and yes-or-no facts must use types that match their meaning. The incident must be concrete: without this constraint, a bad row could violate a business rule that later workflows trust.
