...
Money, timestamps, and yes-or-no facts must use types that match their meaning.
## Task

Write the complete schema repair independently, including the constraints that enforce the named invariant. Target table(s): ecommerce.picking_good_types_c_3.
