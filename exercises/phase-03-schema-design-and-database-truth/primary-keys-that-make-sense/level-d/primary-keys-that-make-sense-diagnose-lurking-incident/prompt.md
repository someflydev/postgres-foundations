# Primary Keys That Make Sense Incident Review
...
Catalog rows need a stable surrogate key while the business sku remains separately unique. The incident must be concrete: without this constraint, a bad row could violate a business rule that later workflows trust.
