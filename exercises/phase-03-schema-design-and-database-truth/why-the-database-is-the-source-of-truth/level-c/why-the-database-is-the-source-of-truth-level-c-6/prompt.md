# Why the Database Is the Source of Truth C6
...
Write the complete schema repair independently, including the constraints that enforce the named invariant. Target table(s): ecommerce.why_the_database_is_the_source_of_truth_c_6.
