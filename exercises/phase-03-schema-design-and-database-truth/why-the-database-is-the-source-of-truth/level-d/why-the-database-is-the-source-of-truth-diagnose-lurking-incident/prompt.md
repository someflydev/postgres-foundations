# Why the Database Is the Source of Truth Incident Review
...
Customer contact imports must reject missing identity and duplicate email facts before any application sees them. The incident must be concrete: without this constraint, a bad row could violate a business rule that later workflows trust.
