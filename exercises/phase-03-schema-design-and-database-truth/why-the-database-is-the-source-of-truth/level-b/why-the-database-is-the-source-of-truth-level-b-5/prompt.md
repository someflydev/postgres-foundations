# Why the Database Is the Source of Truth B5
...
Complete the ALTER TABLE migration using the starter file as the permissive legacy table. Target table(s): ecommerce.why_the_database_is_the_source_of_truth_b_5.
