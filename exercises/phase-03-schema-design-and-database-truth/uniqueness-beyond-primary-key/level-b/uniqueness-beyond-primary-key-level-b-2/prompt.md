# Uniqueness Beyond Primary Key B2
...
Complete the ALTER TABLE migration using the starter file as the permissive legacy table. Target table(s): ecommerce.uniqueness_beyond_primary_key_b_2.
