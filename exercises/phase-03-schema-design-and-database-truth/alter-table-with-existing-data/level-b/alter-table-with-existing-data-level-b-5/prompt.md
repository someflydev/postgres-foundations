# ALTER TABLE With Existing Data B5
...
A live table must be inspected, backfilled, and tightened in a safe order.
## Task

Complete the ALTER TABLE migration using the starter file as the permissive legacy table. Target table(s): ecommerce.alter_table_with_existing_data_b_5.
