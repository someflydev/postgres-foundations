# ALTER TABLE With Existing Data Incident Review
...
A live table must be inspected, backfilled, and tightened in a safe order. The incident must be concrete: without this constraint, a bad row could violate a business rule that later workflows trust.
