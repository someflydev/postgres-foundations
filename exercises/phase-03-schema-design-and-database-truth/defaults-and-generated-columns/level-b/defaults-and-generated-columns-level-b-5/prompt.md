# Defaults and Generated Columns B5
...
Complete the ALTER TABLE migration using the starter file as the permissive legacy table. Target table(s): ecommerce.defaults_and_generated_columns_b_5.
