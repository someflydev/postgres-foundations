# Schema Review for Lurking Bugs Incident Review
...
Schema review must name the bad row, the incident, and the exact constraint repair. The incident must be concrete: without this constraint, a bad row could violate a business rule that later workflows trust.
