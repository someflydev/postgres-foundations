# Schema Review for Lurking Bugs B2
...
Schema review must name the bad row, the incident, and the exact constraint repair.
## Task

Complete the ALTER TABLE migration using the starter file as the permissive legacy table. Target table(s): ecommerce.schema_review_for_lurking_bugs_b_2.
