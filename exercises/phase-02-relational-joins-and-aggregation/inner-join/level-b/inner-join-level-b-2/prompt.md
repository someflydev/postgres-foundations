...
Relevant tables: ecommerce.orders, ecommerce.customers.

## Task

Write the reference query for `Inner Join`. Keep the output small and ordered when the prompt asks for a predictable row set.
