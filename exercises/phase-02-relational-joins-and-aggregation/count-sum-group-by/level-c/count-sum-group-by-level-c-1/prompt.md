...
Relevant tables: ecommerce.orders, ecommerce.order_items.

## Task

Write the reference query for `Count, Sum, and GROUP BY`. Keep the output small and ordered when the prompt asks for a predictable row set.
