# Distinct And Count Distinct Repair Wrong Aggregation
...
The broken review query for `DISTINCT and COUNT DISTINCT` has a wrong aggregation or missing rows problem. It may also hide duplicates, produce an incorrect count, or select non-aggregated selected columns at the wrong grain.
