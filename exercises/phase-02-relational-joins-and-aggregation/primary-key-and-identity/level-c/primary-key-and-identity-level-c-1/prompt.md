# Primary Key And Identity Level C 1
...
Write the reference query for `Primary Key and Identity`. Keep the output small and ordered when the prompt asks for a predictable row set.
