...
Relevant tables: ecommerce.customers, ecommerce.orders, ecommerce.order_items.

## Task

Write the reference query for `Join Then Aggregate`. Keep the output small and ordered when the prompt asks for a predictable row set.
