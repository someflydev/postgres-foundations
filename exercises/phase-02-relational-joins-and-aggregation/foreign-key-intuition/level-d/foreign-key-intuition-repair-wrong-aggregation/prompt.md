# Foreign Key Intuition Repair Wrong Aggregation
...
The broken review query for `Foreign Key Intuition` has a wrong aggregation or missing rows problem. It may also hide duplicates, produce an incorrect count, or select non-aggregated selected columns at the wrong grain.
