# Left Join And Missingness Level A 2
...
Relevant tables: scheduling.providers, scheduling.appointments.

## Task

Write the reference query for `Left Join and Missingness`. Keep the output small and ordered when the prompt asks for a predictable row set.
