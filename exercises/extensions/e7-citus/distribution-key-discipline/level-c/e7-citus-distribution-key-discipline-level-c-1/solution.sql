-- One acceptable answer for e7-citus-distribution-key-discipline-level-c-1.
-- Take the ecommerce workload, propose a distribution key, justify it, create the distributed tables on the citus profile, run the hot queries, and compare plan and timing to the single-node case.
