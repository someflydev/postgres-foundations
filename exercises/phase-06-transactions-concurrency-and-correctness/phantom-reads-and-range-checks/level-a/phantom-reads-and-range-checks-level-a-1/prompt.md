# Phantom Reads and Range Checks Level A1
...
The seed data includes Phase 6 rows for ecommerce inventory, order reservations, scheduling holds, and optional bank account transfer drills. Exercise id: `phantom-reads-and-range-checks-level-a-1`.

## Task

Analyze the phantom reads and range checks scenario and produce the requested Phase 6 outcome.
