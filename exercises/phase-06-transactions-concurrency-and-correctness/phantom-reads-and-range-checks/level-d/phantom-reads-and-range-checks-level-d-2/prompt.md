# Phantom Reads and Range Checks Level D2
...
The seed data includes Phase 6 rows for ecommerce inventory, order reservations, scheduling holds, and optional bank account transfer drills. Exercise id: `phantom-reads-and-range-checks-level-d-2`.
