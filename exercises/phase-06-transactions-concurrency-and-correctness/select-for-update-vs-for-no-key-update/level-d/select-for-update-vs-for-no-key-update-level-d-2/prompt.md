# SELECT FOR UPDATE vs FOR NO KEY UPDATE Level D2
...
The seed data includes Phase 6 rows for ecommerce inventory, order reservations, scheduling holds, and optional bank account transfer drills. Exercise id: `select-for-update-vs-for-no-key-update-level-d-2`.

## Task

Analyze the select for update vs for no key update scenario and produce the requested Phase 6 outcome.
