# SELECT FOR UPDATE vs FOR NO KEY UPDATE Level C1
...
The seed data includes Phase 6 rows for ecommerce inventory, order reservations, scheduling holds, and optional bank account transfer drills. Exercise id: `select-for-update-vs-for-no-key-update-level-c-1`.
