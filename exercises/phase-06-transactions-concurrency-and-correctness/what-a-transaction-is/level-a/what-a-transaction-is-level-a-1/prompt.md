# What a Transaction Is Level A1
...
The seed data includes Phase 6 rows for ecommerce inventory, order reservations, scheduling holds, and optional bank account transfer drills. Exercise id: `what-a-transaction-is-level-a-1`.
