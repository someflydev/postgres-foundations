# What a Transaction Is Level D1
...
The seed data includes Phase 6 rows for ecommerce inventory, order reservations, scheduling holds, and optional bank account transfer drills. Exercise id: `what-a-transaction-is-level-d-1`.
