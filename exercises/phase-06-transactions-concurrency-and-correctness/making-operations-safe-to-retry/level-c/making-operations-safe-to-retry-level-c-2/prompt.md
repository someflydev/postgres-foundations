# Making Operations Safe to Retry Level C2
...
The seed data includes Phase 6 rows for ecommerce inventory, order reservations, scheduling holds, and optional bank account transfer drills. Exercise id: `making-operations-safe-to-retry-level-c-2`.
