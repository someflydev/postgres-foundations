# Making Operations Safe to Retry Level B2
...
The seed data includes Phase 6 rows for ecommerce inventory, order reservations, scheduling holds, and optional bank account transfer drills. Exercise id: `making-operations-safe-to-retry-level-b-2`.
