# Why Deadlocks Happen and How to Avoid Them Level A1
...
The seed data includes Phase 6 rows for ecommerce inventory, order reservations, scheduling holds, and optional bank account transfer drills. Exercise id: `why-deadlocks-happen-and-how-to-avoid-them-level-a-1`.

## Task

Analyze the why deadlocks happen and how to avoid them scenario and produce the requested Phase 6 outcome.
