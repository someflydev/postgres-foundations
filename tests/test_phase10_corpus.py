...
def test_phase10_has_required_lessons_and_exercise_distribution() -> None:
    ...
    assert sum(len(items) for items in exercises_by_lesson.values()) == 97
    for lesson_path in lesson_paths:
        ...
        expected_level_d = 3 if lesson["id"] == "modernization-bridge-pattern" else 2
        assert levels.count("D") == expected_level_d
