...
- **pgvector** — score 0.71 — [module e4-pgvector]
...
| pgvector | 0.94 | 0.98 | 0.96 | 0.65 | 0.85 | 0.10 | 0.72 | 0.71 |
| row_level_security | 0.92 | 0.88 | 0.90 | 0.75 | 0.72 | 0.04 | 0.25 | 0.71 |
| full_text_search | 0.75 | 0.90 | 0.85 | 0.82 | 0.70 | 0.04 | 0.14 | 0.68 |
| pg_trgm | 0.70 | 0.90 | 0.80 | 0.78 | 0.70 | 0.04 | 0.35 | 0.65 |
| gin_trgm_similarity | 0.68 | 0.86 | 0.78 | 0.76 | 0.70 | 0.04 | 0.16 | 0.64 |
| btree_composite_equality_then_range | 0.72 | 0.70 | 0.84 | 0.79 | 0.72 | 0.04 | 0.12 | 0.63 |
| hnsw_vector_anns | 0.74 | 0.88 | 0.82 | 0.63 | 0.77 | 0.10 | 0.40 | 0.63 |
| partial_indexes | 0.70 | 0.72 | 0.82 | 0.74 | 0.77 | 0.04 | 0.16 | 0.62 |
| partial_index_for_skew | 0.70 | 0.72 | 0.82 | 0.74 | 0.77 | 0.04 | 0.16 | 0.62 |
| generated_columns | 0.64 | 0.82 | 0.72 | 0.77 | 0.67 | 0.04 | 0.15 | 0.61 |
| gin_jsonb_containment | 0.64 | 0.82 | 0.72 | 0.71 | 0.66 | 0.04 | 0.22 | 0.59 |
| jsonb | 0.65 | 0.85 | 0.62 | 0.76 | 0.64 | 0.04 | 0.18 | 0.59 |
...
| expression_indexes | 0.62 | 0.74 | 0.70 | 0.75 | 0.64 | 0.04 | 0.13 | 0.58 |
...
```json
{
  ...
  "explicit_bias_for": [
    {
      ...
      "reason": "Hybrid retrieval uses tenant-filtered embeddings."
    },
    {
      "extension_slug": "pg_trgm",
      "reason": "Support queries include typos and product-code fragments."
    }
  ],
  "free_form_notes": "The assistant retrieves support articles and ticket fragments with lexical search, fuzzy matching, embeddings, tenant filters, and deletion workflows. Embeddings have model versions and offline relevance tests, so vector search is no longer speculative.",
  "intake_id": "knowledge-support-ai-assistant-backend",
  ...
  "organization": {
    ...
    "team_size_engineers": 16
  },
  "scale_signals": {
    "concurrent_connections_peak": 340,
    "growth_rate_month_over_month": 0.1,
    "read_throughput_qps": 1900,
    "row_counts_largest_tables": {
      "article_chunks": 6200000,
      "tenant_memberships": 1400000,
      "ticket_chunks": 18000000
    },
