...
| -------------- | ------ | ---- | -------- | --- | ------ | ----------- | ---------- | ----- |
| constraints | 0.86 | 0.90 | 0.82 | 0.87 | 0.72 | 0.04 | 0.06 | 0.71 |
| pg_stat_statements | 0.92 | 0.70 | 0.94 | 0.86 | 0.81 | 0.04 | 0.12 | 0.71 |
| partitioning | 0.76 | 0.86 | 0.84 | 0.71 | 0.88 | 0.04 | 0.30 | 0.67 |
| brin_append_only_chronological | 0.72 | 0.84 | 0.80 | 0.82 | 0.83 | 0.04 | 0.12 | 0.67 |
| pgbouncer | 0.84 | 0.70 | 0.90 | 0.79 | 0.90 | 0.24 | 0.35 | 0.66 |
| pgbouncer_in_front | 0.82 | 0.68 | 0.88 | 0.76 | 0.89 | 0.08 | 0.35 | 0.65 |
| btree_composite_equality_then_range | 0.72 | 0.70 | 0.84 | 0.79 | 0.72 | 0.04 | 0.12 | 0.63 |
| partial_indexes | 0.70 | 0.72 | 0.82 | 0.75 | 0.77 | 0.04 | 0.16 | 0.62 |
| partial_index_for_skew | 0.70 | 0.72 | 0.82 | 0.75 | 0.77 | 0.04 | 0.16 | 0.62 |
| materialized_views | 0.66 | 0.66 | 0.74 | 0.78 | 0.71 | 0.04 | 0.16 | 0.59 |
| physical_replication | 0.68 | 0.62 | 0.80 | 0.71 | 0.75 | 0.08 | 0.22 | 0.58 |
| btree_covering_include | 0.62 | 0.66 | 0.78 | 0.74 | 0.70 | 0.04 | 0.18 | 0.58 |
| primary_with_read_replicas | 0.70 | 0.62 | 0.82 | 0.66 | 0.75 | 0.10 | 0.35 | 0.57 |
| pg_partman | 0.64 | 0.82 | 0.74 | 0.59 | 0.85 | 0.24 | 0.38 | 0.57 |
| timescaledb | 0.68 | 0.86 | 0.76 | 0.43 | 0.88 | 0.24 | 0.72 | 0.55 |
| pgcrypto | 0.60 | 0.64 | 0.60 | 0.82 | 0.59 | 0.04 | 0.12 | 0.54 |
| pgvector | 0.45 | 0.40 | 0.50 | 0.56 | 0.59 | 0.08 | 0.72 | 0.37 |
...
```json
{
  ...
  "explicit_bias_for": [],
  "free_form_notes": "They claim a strong RPO target but have not documented restore drills for partition metadata, large BRIN indexes, or audit exports. The workload is trading-adjacent rather than order matching, so correctness and reconciliation explainability outrank microsecond latency. Growth horizon: 6, 12, and 24 months. Restore drills are not documented.",
  "intake_id": "fintech-high-volume-trading-adjacent",
  ...
  "organization": {
    ...
    "team_size_engineers": 72
  },
  "scale_signals": {
    "concurrent_connections_peak": 1450,
    "growth_rate_month_over_month": 0.18,
    "read_throughput_qps": 11200,
    "row_counts_largest_tables": {
      "fills": 210000000,
      "ledger_entries": 410000000,
      "risk_snapshots": 98000000
    },
    "write_throughput_rows_per_sec": 2400
  },
