...
```json
{
  ...
  "explicit_bias_for": [
    {
      ...
      "reason": "Zone containment and nearest facility predicates are product-critical."
    }
  ],
  "free_form_notes": "Dispatch uses polygon containment, distance, and region boundary intersections on every quote. Breadcrumb retention is 180 days and time-window scans dominate investigations. TimescaleDB is being discussed for compression, but partitioning and BRIN have not been fully measured.",
  "intake_id": "logistics-multi-region-zones",
  ...
  "organization": {
    ...
    "team_size_engineers": 15
  },
  "scale_signals": {
    "concurrent_connections_peak": 360,
    "growth_rate_month_over_month": 0.12,
    "read_throughput_qps": 1800,
    "row_counts_largest_tables": {
      "delivery_breadcrumbs": 145000000,
      "service_zones": 9200,
      "shipments": 18000000
    },
    "write_throughput_rows_per_sec": 620
  },
